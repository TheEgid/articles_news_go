...
import (
	"fmt"
	"github.com/TheEgid/articles-site-go/application/food_app"
...
type Food struct {
	foodApp food_app.FoodAppInterface
...
//Food constructor
func NewFood(fApp food_app.FoodAppInterface) *Food { //, uApp application.UserAppInterface, fd fileupload.UploadFileInterface, rd auth.AuthInterface, tk auth.TokenInterface)
	return &Food{
		foodApp: fApp,
		//userApp:    uApp,
		//fileUpload: fd,
